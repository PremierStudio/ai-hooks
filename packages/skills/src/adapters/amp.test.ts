...
import { AmpSkillAdapter } from "./amp.js";
import type { SkillDefinition } from "../types/index.js";

describe("AmpSkillAdapter", () => {
  let adapter: AmpSkillAdapter;
  ...
  describe("generate", () => {
    it("generates one file per skill", async () => {
      ...
      expect(files[0]?.path).toBe(".amp/prompts/review.md");
